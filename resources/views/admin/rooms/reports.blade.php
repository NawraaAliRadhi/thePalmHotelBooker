                                    ...
                                    <table class="table table-responsive-sm" id="data-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="color-primary"><b>{{\App\Helpers\Helper::displayMoney($room->price_per_night)}}</b></td>
                                                ...
                                                <td><a href="/admin/rooms/update/{{$room->id}}" class="btn btn-primary" style="margin-bottom: 7px">Update</a>

                                                    <form method="POST" action="/admin/rooms/delete/{{$room->id}}" onsubmit="return confirm('Do you really want to delete this room?');">
                                                        @csrf
