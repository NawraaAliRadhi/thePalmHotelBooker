             ...
             <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mar-bottom-30">
                   <div class="footer-contact">
                      ...
                      <ul>
                         <li>Tel: 1777-8574 </li>
                         <li>Email: <a href="https://htmldesigntemplates.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="70191e161f30181f0405085e131f1d5e1e00">[email&#160;protected]</a></li>
                         <li>Fax: 977-222-444-666</li>
                         <li>Address: Juffair, Bahrain</li>
                      </ul>
                   </div>
                </div>
             </div>
          ...
          <div class="row">
             <div class="col-lg-4 mar-bottom-10">
                <div class="copyright-content">
                   <p>Copyright 2019. Made with <span>♥</span>. All Rights Reserved. <a href="#">The Palm</a></p>
                   <ul>
